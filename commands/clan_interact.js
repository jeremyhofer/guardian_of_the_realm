module.exports = {
  join (args, client, msg, player_data) {
  ...
  pledge (args, client, msg, player_data) {
  ...
  siege (args, client, msg, player_data) {
  ...
  truce (args, client, msg, player_data) {
  ...
  war (args, client, msg, player_data) {
